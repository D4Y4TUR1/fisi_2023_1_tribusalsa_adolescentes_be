const db = require('../config/config');     //usar la variable db de config
const bcrypt = require('bcryptjs')

const User = {};    //creamos un objeto vacio

User.getAll = () => {       //creamos el metodo para las consultas de todos los usuarios
    const sql = `
    SELECT 
        *
    FROM
    ...
    return db.manyOrNone(sql);  //retorna muchos o ningun usuario
}
